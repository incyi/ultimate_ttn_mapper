...
const uint16_t send_packet_interval = 10;

// Waiting on fix interval
const uint8_t wait_fix_interval = 5;

// LoRaWan keys
static const u1_t dev_eui[8]  = DEV_EUI;
static const u1_t app_eui[8]  = APP_EUI;
static const u1_t app_key[16] = APP_KEY;
...
/*
        case EV_JOIN_TXCOMPLETE:
            display.println("Join Tx Complete");
            break;
*/
        case EV_RFU1:
...
/*
        case EV_TXSTART:
            display.println("TX Start");
            break;
*/
/*
        case EV_TXCANCELED:
            display.println("TX Canceled");
            break;
*/
        case EV_TXCOMPLETE:
            display.addComplete();
